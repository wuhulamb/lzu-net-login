...
def login(count, account_username, account_password):
    ...
    try:
        ...
        try:
            ...
            account.click()
            time.sleep(3)
            elearning = driver.find_element(By.ID, value="domain")
            elearning.click()
            elearning = elearning.find_element(By.CSS_SELECTOR, '[value="@study"]')
            elearning.click()
...
chrome_driver_path = "/home/xu/Public/chromedriver-linux64/chromedriver"
